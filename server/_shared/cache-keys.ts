...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast' | 'on-demand'> = {
  ...
  bisDsr: 'on-demand', bisPropertyResidential: 'on-demand', bisPropertyCommercial: 'on-demand',
  imfMacro: 'on-demand', imfGrowth: 'on-demand', imfLabor: 'on-demand', imfExternal: 'on-demand',
  ...
  eurostatHousePrices: 'on-demand',
  eurostatGovDebtQ: 'on-demand',
  eurostatIndProd: 'on-demand',
  euFsi: 'slow',
  shippingStress: 'fast',
  socialVelocity: 'fast',
  wsbTickers: 'fast',
  ...
  electricityPrices:   'on-demand',
  jodiOil:             'on-demand',
  chokepointBaselines: 'on-demand',
  portwatchChokepointsRef: 'on-demand',
  portwatchPortActivity: 'on-demand',
  oilStocksAnalysis: 'slow',
  lngVulnerability: 'slow',
  sprPolicies: 'on-demand',
  pipelinesGas: 'slow',
  pipelinesOil: 'slow',
  storageFacilities: 'slow',
  fuelShortages: 'slow',
  energyDisruptions: 'on-demand',
